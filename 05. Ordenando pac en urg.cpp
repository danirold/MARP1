...
bool operator<(tPaciente const& paciente1, tPaciente const& paciente2) {
    return paciente1.gravedad > paciente2.gravedad || (paciente1.gravedad == paciente2.gravedad && paciente1.turno < paciente2.turno);
}

bool resuelveCaso() {
    int num_eventos; cin >> num_eventos;
    ...
    while (num_eventos > 0) {
        ...
        if (evento == 'I') {
            ...
            int gravedad; cin >> gravedad;
            pacientes.push({ nombre, gravedad, turno});
        }
        else if (evento == 'A') {
